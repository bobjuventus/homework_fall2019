...
class ACAgent(BaseAgent):
    ...
    def estimate_advantage(self, ob_no, next_ob_no, re_n, terminal_n):
        ...
        v_s1 = self.critic.forward(next_ob_no)
        # v_s = self.sess.run(self.critic.critic_prediction, feed_dict = {self.critic.sy_ob_no: ob_no})
        # v_s1 = self.sess.run(self.critic.critic_prediction, feed_dict = {self.critic.sy_ob_no: next_ob_no})
        adv_n = re_n + self.gamma * v_s1 * (1 - terminal_n) - v_s
