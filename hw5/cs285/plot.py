...
def plot_data(data, value="AverageReturn"):
    ...
    plt.legend(loc='best').set_draggable(state=True) # use set_draggable for matplotlib >= 3.1.0
    # plt.legend(loc='best', bbox_to_anchor=(1, 1), fontsize=8).set_draggable(state=True)
    plt.show()
